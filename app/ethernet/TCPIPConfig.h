...
//#define EMAC_TX_DESCRIPTORS from 2 to 8 changed
// =======================================================================
...
#define TCP_PIC_RAM_SIZE                (16384ul) //(7296ul)//(6096ul)
...
ROM struct {
    ...
    {TCP_PURPOSE_GENERIC_TCP_CLIENT, TCP_PIC_RAM, 1500, 1500},
    {TCP_PURPOSE_GENERIC_TCP_SERVER, TCP_PIC_RAM, 1500, 1500},
    //{TCP_PURPOSE_TELNET, TCP_PIC_RAM, 0, 1},
    //{TCP_PURPOSE_TELNET, TCP_PIC_RAM, 0, 1},
    //{TCP_PURPOSE_TELNET, TCP_PIC_RAM, 0, 1},
    //{TCP_PURPOSE_FTP_COMMAND, TCP_PIC_RAM, 0, 1},
    //{TCP_PURPOSE_FTP_DATA, TCP_PIC_RAM, 0, 1},
    //{TCP_PURPOSE_TCP_PERFORMANCE_TX, TCP_PIC_RAM, 0, 1},
    //{TCP_PURPOSE_TCP_PERFORMANCE_RX, TCP_PIC_RAM, 0, 1},
    //{TCP_PURPOSE_UART_2_TCP_BRIDGE, TCP_PIC_RAM, 0, 1},
    {TCP_PURPOSE_HTTP_SERVER, TCP_PIC_RAM, 1500, 1500},
    {TCP_PURPOSE_HTTP_SERVER, TCP_PIC_RAM, 1500, 1500},
    {TCP_PURPOSE_DEFAULT, TCP_PIC_RAM, 1000, 1000},
    //{TCP_PURPOSE_BERKELEY_SERVER, TCP_PIC_RAM, 0, 1},
    //{TCP_PURPOSE_BERKELEY_SERVER, TCP_PIC_RAM, 0, 1},
    //{TCP_PURPOSE_BERKELEY_SERVER, TCP_PIC_RAM, 0, 1},
